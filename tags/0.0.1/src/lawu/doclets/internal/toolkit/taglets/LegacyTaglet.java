/*
 * @(#)LegacyTaglet.java	1.5 05/11/17
 *
 * Copyright 2006 Sun Microsystems, Inc. All rights reserved.
 * SUN PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */

package lawu.doclets.internal.toolkit.taglets;
 ...
 * {@link lawu.doclets.Taglet} type taglets to work
...
public class LegacyTaglet implements Taglet {
    ...
    private lawu.doclets.Taglet legacyTaglet;
    
    public LegacyTaglet(lawu.doclets.Taglet t) {
        legacyTaglet = t;
    }
