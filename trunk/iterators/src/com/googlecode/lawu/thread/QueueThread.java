...
public abstract class QueueThread<T> extends SpecializedThread {
	...
	/**
	 * Prepares and returns backing queue for this thread. Will be called once.
	 * Default implementation gives a plain old linked list.
	 * 
	 ...
	 * element in the queue. While the result is positive, the thread to wait
