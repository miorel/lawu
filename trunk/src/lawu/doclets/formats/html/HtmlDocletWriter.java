/*
 * @(#)HtmlDocletWriter.java	1.187 06/04/07
 *
...
import lawu.doclets.formats.html.markup.*;
...
public class HtmlDocletWriter extends HtmlDocWriter {
    ...
    private String redirectRelativeLinks(Doc doc, String text) {
        ...
        if(! redirectPathFromRoot.endsWith(Character.toString(DirectoryManager.URL_FILE_SEPARATOR)))
