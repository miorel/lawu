/*
 * @(#)HtmlDocWriter.java	1.61 07/01/26
 *
 ...
 * are used by the Sub-Classes in the package lawu.doclets.standard
 * and lawu.doclets.oneone.
 *
 * @since 1.2
...
public abstract class HtmlDocWriter extends HtmlWriter {
    ...
    public void printFramesetHeader(String title, boolean noTimeStamp) {
        ...
        if (getConfiguration().charset.length() > 0) {
            println("<meta http-equiv=\"Content-Type\" content=\"text/html; "
                        + "charset=" + getConfiguration().charset + "\">");
        }
        title();
        println(title);
        endTitle();
